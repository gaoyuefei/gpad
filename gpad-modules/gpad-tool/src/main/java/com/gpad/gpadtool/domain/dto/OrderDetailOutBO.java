 ...
 * @Description GRT待交车订单详情Dto
 * @createTime 2023年09月21日 15:57:00
 */
@Data
@ApiModel(value = "OrderDetailOutBO", description = "GRT待交车订单详情OutBO")
public class OrderDetailOutBO {
